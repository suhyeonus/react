 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<6a362a803fbebcd4f21252ef19b09270>>
 */
...
function isFragmentInstanceHostParent(fiber) {
  return (
    5 === fiber.tag || 27 === fiber.tag || 3 === fiber.tag || 4 === fiber.tag
  );
}
...
function prepareFreshStack(root, lanes) {
  ...
  if (0 !== endTime)
    for (root = root.entanglements, endTime &= lanes; 0 < endTime; )
      (clampedRenderStartTime$236 = 31 - clz32(endTime)),
        (eventIsRepeat = 1 << clampedRenderStartTime$236),
        (lanes |= root[clampedRenderStartTime$236]),
...
if (
  "19.3.0-native-fb-809280d5-20260811" !==
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_3071 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_3071.isDisabled &&
    hook$jscomp$inline_3071.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_3071.inject(
        internals$jscomp$inline_2489
      )),
        (injectedHook = hook$jscomp$inline_3071);
    } catch (err) {}
}
