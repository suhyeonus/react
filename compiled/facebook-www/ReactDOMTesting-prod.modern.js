...
var internals$jscomp$inline_2619 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2620 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2620.isDisabled &&
    hook$jscomp$inline_2620.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2620.inject(
        internals$jscomp$inline_2619
      )),
        (injectedHook = hook$jscomp$inline_2620);
    } catch (err) {}
}
