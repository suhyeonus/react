      ...
      if (
        ...
        resource$294 ||
          ...
          (styles$293 = JSCompiler_inline_result.querySelector(
            ...
            : ((styles$293 = preloadPropsMap.get(type)),
              styles$293 ||
                ((styles$293 = {
                  rel: "preload",
                  as: "style",
                ...
                preloadPropsMap.set(type, styles$293)),
              preloadStylesheet(
                JSCompiler_inline_result,
                type,
                styles$293,
...
if (
  "19.3.0-www-classic-ec61f187-20260806" !==
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (
    !hook$jscomp$inline_2612.isDisabled &&
    hook$jscomp$inline_2612.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2612.inject(
        internals$jscomp$inline_2611
      )),
        (injectedHook = hook$jscomp$inline_2612);
    } catch (err) {}
}
