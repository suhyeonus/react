...
if (
  "19.3.0-www-classic-6c3bd60a-20260824" !==
...
var internals$jscomp$inline_2597 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2598 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2598.isDisabled &&
    hook$jscomp$inline_2598.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2598.inject(
        internals$jscomp$inline_2597
      )),
        (injectedHook = hook$jscomp$inline_2598);
    } catch (err) {}
}
