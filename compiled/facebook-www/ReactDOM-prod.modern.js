  ...
  if (didBailout)
    for (var child$123 = completedWork.child; null !== child$123; )
      (newChildLanes |= child$123.lanes | child$123.childLanes),
        (subtreeFlags |= child$123.subtreeFlags & 1206910976),
        (subtreeFlags |= child$123.flags & 1206910976),
...
function renderRootSync(root, lanes, shouldYieldForPrerendering) {
  ...
  a: do
    try {
      ...
      break;
    } catch (thrownValue$205) {
      handleThrow(root, thrownValue$205);
    }
  while (1);
      ...
      for (lastDefaultValue in nextProps)
        if (
          ...
          switch (lastDefaultValue) {
            case "selected":
              propKey$249 !== propKey && trackHostMutation();
              domElement.selected =
                propKey$249 &&
      ...
      if (
        ...
        resource$297 ||
          ...
          (styles$296 = JSCompiler_inline_result.querySelector(
            ...
            : ((styles$296 = preloadPropsMap.get(type)),
              styles$296 ||
                ((styles$296 = {
                  rel: "preload",
                  as: "style",
                ...
                preloadPropsMap.set(type, styles$296)),
              preloadStylesheet(
                JSCompiler_inline_result,
                type,
                styles$296,
...
if (
  "19.3.0-www-modern-809280d5-20260811" !==
...
var internals$jscomp$inline_2585 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2586 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2586.isDisabled &&
    hook$jscomp$inline_2586.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2586.inject(
        internals$jscomp$inline_2585
      )),
        (injectedHook = hook$jscomp$inline_2586);
    } catch (err) {}
}
